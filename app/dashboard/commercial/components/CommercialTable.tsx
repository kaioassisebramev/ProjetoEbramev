...
export function CommercialTable({ enrollments }: CommercialTableProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="🔍 Buscar aluno no setor Comercial..."
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {filteredEnrollments.length === 0 ? (
                ...
                filteredEnrollments.map((enrollment) => {
                  const statusInfo = getEnrollmentStatus(enrollment, 'COMMERCIAL');
                  const status = Array.isArray(statusInfo) ? statusInfo[1] : statusInfo;
                  const missingFields = getMissingFields(enrollment, 'COMMERCIAL');
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link
                          href={`/dashboard/enrollment/${enrollment.id}?tab=commercial`}
