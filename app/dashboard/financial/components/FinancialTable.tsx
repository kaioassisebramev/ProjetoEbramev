...
export function FinancialTable({ enrollments }: FinancialTableProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="🔍 Buscar aluno no setor Financeiro..."
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {filteredEnrollments.length === 0 ? (
                ...
                filteredEnrollments.map((enrollment) => {
                  const statusInfo = getEnrollmentStatus(enrollment, 'FINANCIAL');
                  const status = Array.isArray(statusInfo) ? statusInfo[0] : statusInfo;
                  const missingFields = getMissingFields(enrollment, 'FINANCIAL');
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link
                          href={`/dashboard/enrollment/${enrollment.id}?tab=financial`}
                        ...
                        <div className="text-sm text-gray-900">
                          {enrollment.contractValue
                            ? new Intl.NumberFormat('pt-BR', {
                                style: 'currency',
                                currency: 'BRL',
                              }).format(enrollment.contractValue)
                            : 'R$ 0,00'}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
