...
export const notaFiscalSchema = z.object({
  ...
  dataEmissao: z.string().datetime().or(z.date()),
  dataVencimento: z.string().datetime().or(z.date()),
...
export const exportExcelSchema = z.object({
  dataInicial: z.string().datetime().or(z.date()),
  dataFinal: z.string().datetime().or(z.date()),
});
